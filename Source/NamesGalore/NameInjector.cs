...
namespace NamesGaloreLatin
{
    ...
    {
        static HashSet<string> supportedLangages = new HashSet<string> { "English" };
        ...
        static NameInjector()
        {
            Log.Message("NamesGaloreLatin: Injecting Names");
            ...
            if (NamesGaloreLatinMod.settings.international)
            {
        ...
        {
            if (NamesGaloreLatinMod.settings.logging)
        ...
        {
            bool count = NamesGaloreLatinMod.settings.logging;
        ...
        {
            return Path.Combine(Path.Combine(NamesGaloreLatinMod.settings.rootDir, relativeLanguagePath), Path.Combine("Names", fileName));
        }
