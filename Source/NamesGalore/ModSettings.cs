...
{
    public class NamesGaloreLatinSettings : ModSettings
    {
    ...
    class NamesGaloreLatinMod : Mod
    {
        public static NamesGaloreLatinSettings settings;

        public NamesGaloreLatinMod(ModContentPack content) : base(content)
        {
            settings = GetSettings<NamesGaloreLatinSettings>();
